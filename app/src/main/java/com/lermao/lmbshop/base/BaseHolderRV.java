...
public abstract class BaseHolderRV<T> extends RecyclerView.ViewHolder {
    ...
    private View.OnLongClickListener mOnLongClickListener=new View.OnLongClickListener(){
        ...
        public boolean onLongClick(View view) {
            onItemLong(itemView, position, bean);
            return false;
        }
    };
    ...
    public BaseHolderRV(Context context, ViewGroup parent,
        ...
        super.itemView.setOnLongClickListener(mOnLongClickListener);
    }

    protected void onItemLong(View itemView, int position, T bean){
